...
## Context
Employee Handbook §9 requires appropriate authority and, where applicable, Legal
review before binding the company. The guardrail must **block** signing on
behalf of another person, and **block** signing a contract that requires
delegated authority or legal review without that authority, while **allowing**
routine authorized signing.
